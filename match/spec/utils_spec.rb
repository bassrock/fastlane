  ...
  describe Match::Utils do
    ...
    describe "fill_environment" do
      it "#environment_variable_name uses the correct env variable" do
        result = Match::Utils.environment_variable_name(app_identifier: "tools.fastlane.app", type: "appstore", platform: "ios")
        expect(result).to eq("sigh_tools.fastlane.app_appstore_ios")
      end

      it "#environment_variable_name_team_id uses the correct env variable" do
        result = Match::Utils.environment_variable_name_team_id(app_identifier: "tools.fastlane.app", type: "appstore", platform: "ios")
        expect(result).to eq("sigh_tools.fastlane.app_appstore_team-id_ios")
      end

      it "#environment_variable_name_profile_name uses the correct env variable" do
        result = Match::Utils.environment_variable_name_profile_name(app_identifier: "tools.fastlane.app", type: "appstore", platform: "ios")
        expect(result).to eq("sigh_tools.fastlane.app_appstore_profile-name_ios")
      end
